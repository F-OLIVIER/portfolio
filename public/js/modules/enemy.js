        ...
        for (let y = 0; y < grille[x].length; y++) {
            if (grille[x][y] === 't' && levelCounter < 4) { // ennemie basique (levels 1 à 3)
                ...
                if (randomize() == 13 && !elem.classList.contains('wall') && !elem.classList.contains('block')) {
                    ...
                    enemy.style.backgroundImage = "url('../../public/img/bomberman/level_" + levelCounter + "/enemy.png')";
                ...
                enemy.style.left = y * 50 + 16 + 'px';
                if (grille[x][y] === 'h') {
                    enemy.style.backgroundImage = "url('../../public/img/bomberman/level_3/boss.png')";
                } else if (grille[x][y] === 'H') {
                    enemy.style.backgroundImage = "url('../../public/img/bomberman/level_4/boss_1.png')";
...
export async function enemyDeath(enemy_id) {
    ...
    if (enemy.classList.contains('miniboss')) {
        ...
        if (lifeMiniBoss == 0) { // mort du miniboss
            enemy.style.backgroundImage = "url('../../public/img/bomberman/level_3/miniboss_death.png')";
            ...
            enemy.style.backgroundImage = "url('../../public/img/bomberman/level_3/boss_damage.png')";
        ...
        if (lifeBigBoss == 0) { // mort du boss
            enemy.style.backgroundImage = "url('../../public/img/bomberman/level_4/boss_death.png')";
            enemy.classList.add('deadboss');
            ...
            enemy.style.backgroundImage = "url('../../public/img/bomberman/level_4/boss_1_damage.png')";
            enemy.classList.add('damageboss');
            setTimeout(function () {
                enemy.style.backgroundImage = "url('../../public/img/bomberman/level_4/boss_2.png')";
                enemy.classList.remove('damageboss');
            }, 1000);
            enemySpeed = 800;
            ...
            enemy.style.backgroundImage = "url('../../public/img/bomberman/level_4/boss_2_damage.png')";
            enemy.classList.add('damageboss');
            setTimeout(function () {
                enemy.style.backgroundImage = "url('../../public/img/bomberman/level_4/boss_2.png')";
                enemy.classList.remove('damageboss');
        ...
        enemy.style.backgroundImage = "url('../../public/img/bomberman/all_level/enemy_death.png')";
