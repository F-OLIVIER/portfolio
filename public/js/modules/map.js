    ...
    for (let x = 0; x < grille.length; x++) {
        ...
        for (let y = 0; y < grille[x].length; y++) {
            ...
            if (grille[x][y] === 'B') {
                ...
                elem.style.backgroundImage = "url('../../public/img/bomberman/level_" + levelCounter + "/wall.png')";
            } else {
                ...
                if (objectType > 13 && grille[x][y] === 't') {
                    ...
                    elem.style.backgroundImage = "url('../../public/img/bomberman/level_" + levelCounter + "/wall_animed.png')";
                } else {
                    elem.style.backgroundImage = "url('../../public/img/bomberman/level_" + levelCounter + "/ground.png')";
                }
                if (!doorAdded && randomize() === 15 && grille[x][y] === 't' && levelCounter < 3) { // placement aléatoire de la porte pour les levels 1 et 2
                    ...
                    if (levelCounter == 1) {
                        ...
                        elem.style.backgroundImage = "url('../../public/img/bomberman/all_level/door.png')";
                    } else {
                        if (!elem.classList.contains('wall')) {
                            elem.classList.add('wall');
                        }
